...
const PersonalInfoPage = () =>{
    ...
    return(
        ...
        <div className = "personaInfo">
            ...
            {modify3?<input type="text" className="personalInfos2 pIinput1" autoFocus defaultValue={userInfo.address?userInfo.address:"No address"} onChange={e =>{setAddress(e.target.value)}}></input>
